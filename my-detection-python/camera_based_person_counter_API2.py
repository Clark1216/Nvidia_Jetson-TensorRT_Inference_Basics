...
logging.basicConfig(
    handlers=[RotatingFileHandler('camera_based_person_counter_API2.log', maxBytes=100000, backupCount=2)],
    level=logging.INFO,
...
def Camera_Setting():
    ...
    logging.info('Camera setting finished.')
...
def index():
    ...
    while count_tmp < 8:
        ...
        logging.info('+++++++HUMAN DETECTING LOOP+++++++++++')
    ...
    if set((a)) == {-1}:
        ...
        logging.info('final count is, %d' % tmp)
...
if __name__ == '__main__':
    ...
    logging.info("1 min counting down to launch webapp")
    time.sleep(60)
